  ...
  <div class="my-container">
    ...
    <div class="user-info-wrap" v-if="$store.state.user">
      <div class="base-info-wrap">
        <div class="avatar-title-wrap" @click="$router.push(`/user/${userMessage.id}`)">
          <van-image
            class="avatar"
            round
            fit="cover"
            :src="userMessage.photo?userMessage.photo:`https://img.yzcdn.cn/vant/cat.jpeg`"
          />
      ...
      <van-grid class="data-info" :border="false">
        <van-grid-item>
          <span class="count">{{ userMessage.art_count }}</span>
          <span class="text">头条</span>
        </van-grid-item>
        <van-grid-item>
          <span class="count">{{ userMessage.follow_count}}</span>
          <span class="text">关注</span>
        </van-grid-item>
        <van-grid-item>
          <span class="count">{{ userMessage.fans_count}}</span>
          <span class="text">粉丝</span>
        </van-grid-item>
        <van-grid-item>
          <span class="count">{{ userMessage.like_count}}</span>
